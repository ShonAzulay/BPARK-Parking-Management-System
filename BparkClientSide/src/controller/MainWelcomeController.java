...
public class MainWelcomeController {
    ...
    private void handleManagement() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/gui/managementGUI.fxml"));
    ...
    private void handleAppAccess() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/gui/clientGUI.fxml"));
            Parent root = loader.load();
    ...
    private void handleTerminalAccess() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/gui/terminalGUI.fxml"));
            Parent root = loader.load();
