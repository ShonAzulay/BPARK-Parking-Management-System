...
The project focuses on software architecture, client–server communication, and system design, rather than on full commercial-grade deployment or payment accuracy.

The system is implemented using Java, JavaFX, an OCSF-based client–server architecture, and a MySQL database.

🚗 System Overview

BPARK simulates core workflows of a parking management system, including reservations, parking session tracking, and management operations.
...
Payment calculation is intentionally simplified and not the focus of the project.
