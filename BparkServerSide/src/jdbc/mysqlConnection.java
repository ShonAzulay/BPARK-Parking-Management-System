	            ...
	            while (rs.next()) {
	                ...
	                """)) {
	                    ...
	                    if (lateRs.next()) {
	                        ...
	                        if (lateCount == 2) {
	                            try {
	                                new NotificationController().sendTowingWithLateChargeEmail(email, vehicleNumber, spot);
	                ...
	                if (email != null && !sentCombinedEmail) {
	                    try {
	                        new NotificationController().sendTowingNoticeEmail(email, vehicleNumber, spot);
